package com.mobilecomputing.one_sec.services;
...
import com.mobilecomputing.one_sec.db.CommLockInfoManager;
import com.mobilecomputing.one_sec.model.CommLockInfo;
import com.mobilecomputing.one_sec.model.FaviterInfo;
import com.mobilecomputing.one_sec.utils.NotificationUtil;
...
public class LoadAppListService extends IntentService {
    ...
    public void onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationUtil.createNotification(this,"One-Sec","One-Sec Services running in background");
        }
    }
